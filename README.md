...
- [`onboarding/`](./onboarding/) – how interest flows in, how we triage projects and contributors, and how we run discovery sessions.
- [`foundry/`](./foundry/) – how projects join the Foundry, what we provide, and how the project lifecycle works.
- [`lab/`](./lab/) – how we convene working groups, hackathons, special interest groups, ideation popups, and curated conversations.
